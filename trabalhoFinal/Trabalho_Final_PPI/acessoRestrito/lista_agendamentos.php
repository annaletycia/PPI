...
try {
  ...
  $sql = <<<SQL
  SELECT data_consulta, horario, nome_paciente, sexo_paciente, email_paciente, id_medico
  FROM agenda
  SQL;
...
<?php
  while ($row = $stmt->fetch()) {
    ...
    $sexo_paciente = htmlspecialchars($row['sexo_paciente']);
    $email_paciente = htmlspecialchars($row['email_paciente']);
